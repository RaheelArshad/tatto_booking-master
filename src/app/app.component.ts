...
export class AppComponent {
  ...
  constructor(
    ...
    // const loginStatus = localStorage.getItem('isUserLogged');
    // if (loginStatus === null) {
...
//       this.navCtrl.navigateRoot("");
    ...
    // in development manan339
    console.log(localStorage.getItem('isUserLogged'));
    if (localStorage.getItem("whitelogo") === null) {
      console.log(localStorage.getItem("whitelogo"));
      // this.navCtrl.navigateRoot("login");
    } else {
      console.log(localStorage.getItem("whitelogo"));
      // this.navCtrl.navigateRoot("tabs/home");
  ...
  initializeApp() {
    this.platform.ready().then(() => {
      ...
      this.statusBar.backgroundColorByHexString("#00D14D");
      setTimeout(() => {
